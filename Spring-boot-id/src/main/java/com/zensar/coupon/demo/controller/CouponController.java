package com.zensar.coupon.demo.controller;
...
import com.zensar.coupon.demo.Services.CouponServiceImpl;
...
public class CouponController {
	...
	public ResponseEntity<String> updateCoupon(@PathVariable("couponId") int couponId, @RequestBody CouponDto couponDto) {
